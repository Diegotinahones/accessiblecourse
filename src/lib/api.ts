...
function normalizeResource(item: ResourceListItem): ResourceListItem {
  ...
  return {
    ...
    source: item.source ?? sourceUrl ?? filePath,
    url: sourceUrl,
    sourceUrl,
    downloadUrl,
    path: filePath,
    ...
    modulePath,
    moduleTitle: item.moduleTitle ?? modulePath,
    sectionTitle: item.sectionTitle ?? modulePath,
    itemPath,
    ...
    parentId: item.parentId ?? item.parentResourceId ?? null,
    childrenCount: item.childrenCount ?? item.discoveredChildrenCount ?? 0,
