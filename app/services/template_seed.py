...
from app.models import ChecklistItem, ChecklistTemplate, ResourceType
...
TEMPLATE_DEFINITIONS: dict[ResourceType, list[dict[str, str | None]]] = {
    ...
    ResourceType.VIDEO: [
        {"key": "captions", "label": "Incluye subtítulos sincronizados", "description": None, "recommendation": "Añade subtítulos revisados."},
        {"key": "transcript", "label": "Hay transcripción disponible", "description": None, "recommendation": "Publica una transcripción editable."},
        {"key": "language", "label": "El idioma del audio está indicado", "description": None, "recommendation": "Indica el idioma del vídeo."},
    ...
    ResourceType.IMAGE: [
        {"key": "alt_text", "label": "La imagen tiene una descripción útil", "description": None, "recommendation": "Añade una alternativa textual breve y significativa."},
    ],
    ResourceType.OTHER: [
