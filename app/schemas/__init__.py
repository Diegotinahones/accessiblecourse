...
class JobPhase(str, Enum):
    ...
    DOCX_ACCESSIBILITY_SCAN = "DOCX_ACCESSIBILITY_SCAN"
    VIDEO_ACCESSIBILITY_SCAN = "VIDEO_ACCESSIBILITY_SCAN"
    NOTEBOOK_ACCESSIBILITY_SCAN = "NOTEBOOK_ACCESSIBILITY_SCAN"
    DONE = "DONE"
    ERROR = "ERROR"
...
class AccessibilityResourceRead(StrictModel):
    ...
    title: str
    type: str
    analysisType: Literal["HTML", "PDF", "DOCX", "VIDEO", "NOTEBOOK"] | None = None
    accessStatus: str
...
class ReportWordAccessibilitySummaryRead(ReportHtmlAccessibilitySummaryRead):
    pass
...
class ReportAutomaticAccessibilitySummaryRead(StrictModel):
    ...
    wordResourcesDetected: int
    wordResourcesAnalyzed: int
    videoResourcesDetected: int
    videoResourcesAnalyzed: int
    notebookResourcesDetected: int
    notebookResourcesAnalyzed: int
    passCount: int
    failCount: int
    warningCount: int
    notApplicableCount: int
...
class ReportWordCheckRead(ReportHtmlCheckRead):
    pass


class ReportWordResourceRead(StrictModel):
    resourceId: str
    title: str
    coursePath: str
    moduleTitle: str | None = None
...
class ReportVideoCheckRead(ReportHtmlCheckRead):
    pass


class ReportVideoResourceRead(StrictModel):
    resourceId: str
    title: str
    coursePath: str
    moduleTitle: str | None = None
...
class ReportNotebookCheckRead(ReportHtmlCheckRead):
    pass


class ReportNotebookResourceRead(StrictModel):
    resourceId: str
    title: str
    coursePath: str
    moduleTitle: str | None = None
    ...
    mainIssue: str | None = None
    summarized: bool = False
    checks: list[ReportNotebookCheckRead]
...
class JobReportRead(StrictModel):
    ...
    videoResources: list[ReportVideoResourceRead]
    notebookResources: list[ReportNotebookResourceRead]
